 ...
 * @version 2.0
 * Model.Blackboard - central location for the data which needs to be accessed by several data requesters.
...
//    private View.CustomTextArea customTextArea = new View.CustomTextArea(30, 20);
    ...
    /**
     * Model.Blackboard private constructor for singleton Model.Blackboard class
     */
    private Blackboard(){}

    /**
     * getBlackboard - getter method to access the data stored on the Model.Blackboard
     * @return returns the Model.Blackboard object
     */
     ...
     * @param box - Model.UMLComponent to be appended to the BoxList
     */
