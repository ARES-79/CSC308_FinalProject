 ...
 * @version 1.0
 * Model.LoadModel - class which handles the functionality for loading a previously saved state of the draw panel by deserializing an object file of the name entered by the user, if such a file exists
 */
public class LoadModel implements FileHandler {
    ...
    /**
     * deserialize - Deserializes the project state which has the name entered by the user and restores it to the View.DrawPanel, if a project of the entered name exisits
