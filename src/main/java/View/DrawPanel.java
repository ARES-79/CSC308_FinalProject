 ...
 * @version 1.0.1
 * View.DrawPanel - section of the application for drawing Classes
 */
@Setter
@Getter
public class DrawPanel extends JPanel implements MyObserver {
    ...
    /**
     * View.DrawPanel constructor
     *    creates a Controller.DrawPanelController and adds it as the MouseListener and MouseMotionListener
     */
    public DrawPanel(){
     ...
     * @param ob- Model.MyObservable object sending the update
     */
    @Override
