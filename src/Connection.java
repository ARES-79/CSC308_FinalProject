...
//        switch (type){
//            case INHERITANCE -> {
//                drawInheritance(g, false);
//            }
//            case ASSOCIATION -> {
//                List<Integer> coords = drawAssociation(g, true);
//                //g.drawLine(coords.get(0), coords.get(1), coords.get(2), coords.get(3));
//            }
//            case COMPOSITION -> {
//                List<Integer> coords = drawComposition(g, false);
//                g.drawLine(coords.get(0), coords.get(1), coords.get(2), coords.get(3));
//            }
//        }
//    }
...
//     */
//    private List<Integer> drawAssociation(Graphics g, boolean flag){
//        int x1, y1, x2, y2;
//        int[] x_coords;
//        int[] y_coords;
//
...
//     * @return the coordinates to draw the line between
//     */
//    private List<Integer> drawComposition(Graphics g, boolean flag){
//        ArrayList<Integer> coords = (ArrayList<Integer>) drawAssociation(g, false);
//        int x1 = coords.get(0);
//        int y1 = coords.get(1);
//        int[] x_coords;
//        int[] y_coords;
